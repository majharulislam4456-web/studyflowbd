...
export const translations: Translations = {
  ...
  totalSubjects: { en: 'Total Subjects', bn: 'মোট বিষয়' },
  ...
  activeGoals: { en: 'Active Goals', bn: 'সক্রিয় লক্ষ্য' },
  chapters: { en: 'chapters', bn: 'অধ্যায়' },
  overall: { en: 'Overall', bn: 'সম্পূর্ণ' },
  yourSubjects: { en: 'Your Subjects', bn: 'আপনার বিষয়সমূহ' },
  dailyMotivation: { en: 'Daily Motivation', bn: 'দৈনিক অনুপ্রেরণা' },
  morningGreeting: { en: '🌅 Good morning!', bn: '🌅 সুপ্রভাত!' },
  afternoonGreeting: { en: '☀️ Good afternoon!', bn: '☀️ শুভ দুপুর!' },
  eveningGreeting: { en: '🌙 Good evening!', bn: '🌙 শুভ সন্ধ্যা!' },
  nightGreeting: { en: '🌟 Late night grind?', bn: '🌟 রাতের পড়াশোনা?' },
  whatsPlan: { en: "What's the plan today?", bn: 'আজকে কি প্ল্যান?' },
  dayStreak: { en: 'day streak!', bn: 'দিন স্ট্রিক!' },
  startStudying: { en: 'Start studying today! 💪', bn: 'আজ পড়া শুরু করো! 💪' },
  streakHint: { en: '⚠️ Add time in Study Log to start streak', bn: '⚠️ স্টাডি লগে সময় যোগ করলে স্ট্রিক শুরু হবে' },
  hour: { en: 'h', bn: 'ঘ' },
  minute: { en: 'm', bn: 'মি' },
